...
scatterplotMatrix(cbind(lb_ft, bbl_ft, form_avg, oil)#cbind(Brain, Body, Litter, Gestation) 
                  , smooth=FALSE
                  , diagonal="histogram"
                  , col= "steelblue")  
...
```{r}
scatterplotMatrix(cbind(log(lb_ft), log(bbl_ft), form_avg, log(oil))#cbind(Brain, Body, Litter, Gestation) 
                  , smooth=FALSE
                  , diagonal="histogram"
                  , col= "steelblue")  
```
