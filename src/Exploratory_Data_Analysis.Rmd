...
# import data, define columns classes, and store as a tibble
...
# find distinct observations by api number

ff_distinct_api <- fracfocus %>%
    distinct(api)

# combine well data with fracturing chemical data for further analysis
...
# join well data with chemical data and create new explanatory variables for
...
features <- well_data %>% select(lb_ft, bbl_ft, formavg, oil)
